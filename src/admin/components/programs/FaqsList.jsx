  ...
  return (
    <>
      ...
      <Publish title={""} size={"xs"}>
        <ReusableModal
          title={"Are you sure you want to publish this FAQ"}
          actionTitle={"Publish"}
          cancelTitle={"Cancel"}
          closeModal={() => ShowPublish(false)}
          action={() => updateFaqStatus("active")}
          isBusy={isBusy}
        />
      </Publish>
      <Retract title={""} size={"xs"}>
        <ReusableModal
          title={"Are you sure you want to retract this FAQ"}
          actionTitle={"Retract"}
          cancelTitle={"Cancel"}
          closeModal={() => ShowRetract(false)}
          action={() => updateFaqStatus("inactive")}
          isBusy={isBusy}
        />
      </Retract>
      <Delete title={""} size={"xs"}>
        <ReusableModal
          ...
          action={() => deleteThisFaq(selectedId)}
          isBusy={isBusy}
        />
      </Delete>
    </>
